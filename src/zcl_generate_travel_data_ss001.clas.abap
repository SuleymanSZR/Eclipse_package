CLASS zcl_generate_travel_data_ss001 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_ss001 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_ss001.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_ss001.

*   insert the new table entries
    INSERT ztravel_ss001 FROM TABLE @itab.
