CLASS lhc_UXTeam DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS deneme FOR MODIFY
      IMPORTING keys FOR ACTION UXTeam~deneme.
...
CLASS lhc_UXTeam IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITIES OF zrap_ss_i_uxteam_001  IN LOCAL MODE
        ENTITY UXTeam
  ...
  METHOD setActive.
    ...
    MODIFY ENTITIES OF zrap_ss_i_uxteam_001  IN LOCAL MODE
        ENTITY UXTeam
          UPDATE
            FIELDS (  Active )
