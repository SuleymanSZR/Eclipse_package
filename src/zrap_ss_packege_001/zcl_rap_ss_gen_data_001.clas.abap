CLASS zcl_rap_ss_gen_data_001 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap_ss_gen_data_001 IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap_ss_002.

*    "insert travel demo data
*    INSERT zrap_ss_002  FROM (
*        SELECT
...
*   clear data
    DELETE FROM zrap_ss_003.

    "insert travel demo data
    INSERT zrap_ss_003  FROM (
        SELECT
          FROM /dmo/travel AS travel
          FIELDS
            travel~travel_id        AS travel_id,
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zrap_ss_xxx{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
