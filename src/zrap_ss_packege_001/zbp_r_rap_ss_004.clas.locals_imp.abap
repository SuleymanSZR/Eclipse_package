...
CLASS lsc_zr_rap_ss_004 DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zr_rap_ss_004 IMPLEMENTATION.
...
*    reading the building entites
    READ ENTITIES OF zr_rap_ss_004 IN LOCAL MODE
        ENTITY Building
        ALL FIELDS
