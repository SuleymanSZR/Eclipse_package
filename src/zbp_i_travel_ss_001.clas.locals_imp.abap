...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_ss_001.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_travel_ss_001 FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_agency.
    ...
    READ ENTITY zi_travel_ss_001\\travel FROM VALUE #(
  ...
  READ ENTITIES OF zi_travel_ss_001 IN LOCAL MODE
      ENTITY Travel
        FIELDS ( travel_id )
  ...
  "Get max travelID
  SELECT SINGLE FROM ztravel_ss001 FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).

  "update involved instances
  MODIFY ENTITIES OF zi_travel_ss_001 IN LOCAL MODE
    ENTITY Travel
